...
public class SignalRService
{
    ...
    public async Task PublishToTenantChannel(object data) => await PublishToTenantChannel(new Message(data));
    ...
    public async Task PublishToUserChannel(object data) => await PublishToUserChannel(new Message(data));
